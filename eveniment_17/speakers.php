                ...
                <head>
                    ...
                    <style>
                        /* Stilizare pentru a afișa boxele cu speakeri sub formă de listă */
                        .speaker-box {
                ...
                <body>
                    ...
                    $sql ="SELECT S.poza, S.nume, S.descriere  FROM speakers S JOIN eveniment_speakers E ON S.id=E.id_speaker WHERE 17=E.id_eveniment";
