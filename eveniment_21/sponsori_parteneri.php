            ...
            <body>
                ...
                <?php
                    ...
                    $sql ="SELECT S.poza, S.nume, S.descriere  FROM sponsori S JOIN eveniment_sponsori E ON S.id=E.id_sponsor WHERE 21=E.id_eveniment";
                ...
                $sql ="SELECT S.poza, S.nume, S.descriere  FROM parteneri S JOIN eveniment_parteneri E ON S.id=E.id_partener WHERE 21=E.id_eveniment";
                    $result = $conn->query($sql);
